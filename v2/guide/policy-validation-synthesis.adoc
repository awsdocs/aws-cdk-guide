...
[abstract]
--
By using the `Validations` class, you can add validation plugins, custom warnings and errors, and acknowledgments to your {aws} CDK application. Validation runs immediately after synthesis.
--
