...
The AWS CDK Toolkit is installed with the Node Package Manager\. In most cases, we recommend intalling it globally\.
...
### `cdk list` \(`ls`\)<a name="w4aac23b7c35b7b1"></a>
...
### `cdk diff`<a name="w4aac23b7c35b7c11"></a>
